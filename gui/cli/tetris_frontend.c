...
void print_stats(GameInfo_t game) {
  ...
  mvprintw(F_Y_START + 2, F_X_START + WIDTH * CELL_SIZE + 3, "high score: %d",
           game.high_score);
  mvprintw(F_Y_START + 4, F_X_START + WIDTH * CELL_SIZE + 3, "lvl: %d",
           game.level);
  ...
  mvprintw(F_Y_START + 17, F_X_START + WIDTH * CELL_SIZE + 3, "space - rotate");
  mvprintw(F_Y_START + 18, F_X_START + WIDTH * CELL_SIZE + 3, "  p   - pause");
...
void print_game_over(GameInfo_t game) {
  ...
  mvprintw(6, F_X_START + WIDTH * CELL_SIZE + 3, "gover=(");
  ...
  attron(A_BLINK);
  mvprintw(18, F_X_START + WIDTH * CELL_SIZE + 3, "retry?");
  attroff(A_BLINK);
  mvprintw(20, F_X_START + WIDTH * CELL_SIZE + 3, "enter  -  da");
  mvprintw(21, F_X_START + WIDTH * CELL_SIZE + 3, "  q    -  net");
}
