...
LIB_SRC = $(wildcard brick_game/tetris/backend/*.c)
...
install: tetris.a
	@$(CC) $(CFLAGS) -c ./gui/cli/*.c -L. -l:tetris.a
	@$(CC) $(CFLAGS) brick_game/tetris/*.c *.o -o $(EXE_NAME) $(LFLAGS) -L. -l:tetris.a -lncurses
	@mkdir install
	@mv $(EXE_NAME) install/
...
tetris.a: $(LIB_O)
	...
	@ranlib $(LIB_NAME)
	@rm -rf brick_game/tetris/backend/*.o
